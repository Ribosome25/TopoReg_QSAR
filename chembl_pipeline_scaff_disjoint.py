"""
A script for chembl data. Modified from v6 and v7. 
Scaffold split. 
...
def pipe_1(args: ChemblPipelineArgs):
    ...
    Ks = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5]  # Previously. 
    Ks = [0.2, 0.3, 0.4]
    rbf_gammas = [0.2, 0.5, 1, 2, 5]
    rbf_gammas = [0.5]  # shorter time
    ...
    output_path = pj(args.path, "Results_nonneg_Ghosh_scaff.csv")
